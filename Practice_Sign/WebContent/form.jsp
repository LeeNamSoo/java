<!-- 8 -->
<%-- 모든 웹문서를 JSP 파일로 변경하여 사용하는 것을 권장 --%>
<%-- 1. page 디렉티브를 웹문서 맨 위에 선언한다. --%>
<%-- 2. 웹문서의 확장자를 JSP로 변경한다. --%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String msg = request.getParameter("msg");//join.jsp를 요청한 경우 전달되는 메세지 저장
	if(msg==null) msg="";//form.jsp를 요청한 경우
%>
...
<h3 align="center"> 회원가입 </h3>
	<%-- join.jsp에서 전달된 메세지 출력 => form.jsp 요청시 null --%>
